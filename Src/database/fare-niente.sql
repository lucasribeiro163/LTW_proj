...
insert into Pais(idPais, nome) values (10,"Finlandia");
...
insert into Pais(idPais, nome) values (15,"Nova Zelandia");
insert into Pais(idPais, nome) values (16,"Turquia");
insert into Pais(idPais, nome) values (17,"Brasil");
