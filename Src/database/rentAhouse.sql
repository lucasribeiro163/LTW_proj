...
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (1,3,7,"Casa pituresca perto do mar","Esta casa de sonho não estará disponível muito mais tempo.","Av. Afonso Henriques 9035", 35, NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (2,5,10,"Mansão de luxo nos suburbios","Luxo. Requinte. Para si.","Rua S. Caetano, s/n",40, NULL, 8, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (3,1,2,"Apartamento espaçoso no centro da cidade","Cómodo, agil e dinâmico.","Rua da Boavista",35, NULL, 1, 6);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (4,1,1,"Casa moderna com piscina","Diversão para família toda.","Praceta Joao XXI",80, NULL, 3, 5);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (5,4,9,"Casa clássica com salão de chá","Zen, reconquiste a sua paz interior","Av. Esteves Alberto 645", 33, NULL, 8, 6);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (6,3,3,"Apartamento low-budget","Mais barato não podia ser.","Rua D.Pedro III, s/n", 40, NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (7,2,4,"Apartamento com vista para o mar","Pechincha ideal para todos.","Rua da Trindade",43, NULL, 3, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (8,1,2,"Cabana na margem do rio","Ideal para quem gosta de pesca.","Praca Joao I", 23, NULL, 3, 5);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (9,3,7,"Quinta rural com campo de ténis","Perfeito para os amantes de amimais.","Rua do Algarve, 23", 23, NULL, 7, 2);

insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (10,3,5,"Estudio acolhedor com forno a lenha","Já dissemos que é acolhedor, porque é.","Rua do Olhar, 23", 50, NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (11,3,3,"Casa moderna com estúdio musical","Imagine um concerto com os seus amigos","Rua da Gaivota, 30", 70,  NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (12,3,10,"Apartamento moderno com piano","Modernidade com um toque de requinte","Praca D. Pedro, 10", 300, NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (13,3,5,"Apartamento pet-friendly perto da baixa","Traga o seu amigo de quatro patas.","Rua do Mar, 1", 23, NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (14,3,6,"Mansão com escorrega para piscina","Os seus filhos vão adorar","Rua da Alegria, 1000", 20,  NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (15,3,8,"Casa de dois andares com espaço social no telhado","Pores do sol são demais","Rua do Sal, 14", 60,  NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (16,3,4,"Cabana na floresta off-the-grid","Isole-se do mundo","Rua da Areia, 70", 85, NULL, 7, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (17,3,7,"Apartamento com escritório e varanda espaçosa","Hora de acabar o seu trabalho.","Rua do Algarve, 500", 890, NULL, 7, 2);
