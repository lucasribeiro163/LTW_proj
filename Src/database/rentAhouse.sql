...
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (1,1,3,2,7,"Casa pituresca perto do mar","Esta casa de sonho não estará disponível muito mais tempo.","Av. Afonso Henriques 9035", 35, NULL, 7, 2);
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (2,1,5,3,10,"Mansão de luxo nos suburbios","Luxo. Requinte. Para si.","Rua S. Caetano, s/n",40, NULL, 8, 2);
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (3,2,1,1,2,"Apartamento espaçoso no centro da cidade","Cómodo, agil e dinâmico.","Rua da Boavista",35, NULL, 1, 6);
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (4,3,1,1,1,"Casa moderna com piscina","Diversão para família toda.","Praceta Joao XXI",80, NULL, 3, 5);
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (5,3,4,2,9,"Casa clássica com salão de chá","Zen, reconquiste a sua paz interior","Av. Esteves Alberto 645", 33, NULL, 8, 6);
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (6,3,3,2,3,"Apartamento low-budget","Mais barato não podia ser.","Rua D.Pedro III, s/n", 40, NULL, 7, 2);
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (7,4,2,1,4,"Apartamento com vista para o mar","Pechincha ideal para todos.","Rua da Trindade",43, NULL, 3, 2);
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (8,5,1,1,2,"Cabana na margem do rio","Ideal para quem gosta de pesca.","Praca Joao I", 23, NULL, 3, 5);
insert into Habitacao( idDono, numQuartos, numBanho, maxHospedes , titulo , descricaoHabitacao  , morada , precoNoite, classificacaoHabitacao, idCidade, idTipo) values (9,5,3,1,7,"Quinta rural com campo de ténis","Perfeito para os amantes de amimais.","Rua do Algarve, 23", 23, NULL, 7, 2);
