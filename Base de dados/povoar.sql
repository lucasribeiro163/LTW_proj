...
insert into Utilizador (idUtilizador, nome, dataNascimento, email, telefone, morada, codigoPostal, idPais) values (9,"Duarte Lima", "1986-05-27", "dlima@gmail.com", "+351934237443", "Rua Armind Correia", "4500-132", 1);
insert into Utilizador (idUtilizador, nome, dataNascimento, email, telefone, morada, codigoPostal, idPais) values (10,"Desmond Miles", "1970-02-09", "dmiles@gmail.com", "+1-542-744-3410", "2201 N Southeast St, New Orleans", "PA 12343", 2);
insert into Utilizador (idUtilizador, nome, dataNascimento, email, telefone, morada, codigoPostal, idPais) values (11,"Hugh Oliver", "1985-01-09", "holiver@gmail.com", "+359249327743", "Rua da Lua, 212", "4520-330", 1);
insert into Utilizador (idUtilizador, nome, dataNascimento, email, telefone, morada, codigoPostal, idPais) values (12,"Manuel Sousa", "1976-11-23", "msousa@gmail.com", "+35846497443", "Rua da Trsiteza, 413", "4230-780", 1);
insert into Utilizador (idUtilizador, nome, dataNascimento, email, telefone, morada, codigoPostal, idPais) values (13,"Rodrigo Lima", "1974-01-28", "rlima@gmail.com", "+34372443627", "Calle de los Ninos 1234, Barcelona", "25535", 11);
insert into Utilizador (idUtilizador, nome, dataNascimento, email, telefone, morada, codigoPostal, idPais) values (14,"Esteves Trindade", "1982-12-26", "etrindade123@gmail.com", "+4482767742", "6232 Liverpool Mount Rd, Manchester", "56700", 13);
insert into Utilizador (idUtilizador, nome, dataNascimento, email, telefone, morada, codigoPostal, idPais) values (15,"Lolla Trappezi", "1964-04-30", "lollita123@gmail.com", "+3756654727", "Viale Maurizzio Sarri 23, Turim", "08542", 6);
insert into Utilizador (idUtilizador, nome, dataNascimento, email, telefone, morada, codigoPostal, idPais) values (16,"Vladimir Trotski", "1963-12-11", "trotski@gmail.com", "+618989842", "1651 Martin Rd, Camberra", "NSW 2199", 16);
...
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (5,4,9,"Av. Esteves Alberto 645",6, 33, 15, NULL, 8, 6,2);
...
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (10,3,5,"Rua do Olhar, 23",9, 50, 21, NULL, 7, 2, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (11,3,3,"Rua da Gaivota, 30",12, 70, 15, NULL, 7, 2, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (12,3,10,"Praca D. Pedro, 10",7, 300, 20, NULL, 7, 2, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (13,3,5,"Rua do Mar, 1",14, 23, 100, NULL, 7, 2, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (14,3,6,"Rua da Alegria, 1000",25, 20, 36, NULL, 7, 2, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (15,3,8,"Rua do Sal, 14",15, 60, 10, NULL, 7, 2, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (16,3,4,"Rua da Areia, 70",10, 85, 100, NULL, 7, 2, 2);
insert into Habitacao(idHabitacao,numQuartos, maxHospedes,morada, distCentro,precoNoite, taxaLimpeza, classificacaoHabitacao, idCidade, idTipo, idPolitica) values (17,3,7,"Rua do Algarve, 500",5, 890, 20, NULL, 7, 2, 2);
